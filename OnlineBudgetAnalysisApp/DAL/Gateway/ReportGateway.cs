...
namespace OnlineBudgetAnalysisApp.DAL.Gateway
{
    public class ReportGateway : Gateway
    {
        ...
        {
            Query =
                "SELECT CONVERT(CHAR(11), Date, 106) as Date, SKU, Category, Name, Sold, Prices, Total, PackagingCost, ActualShippingCost, UnitCost, MarketFee, VAT, TotalProductionCost, TotalCost, TotalEarning FROM Reports Where ProjectId=@ProjectId";
