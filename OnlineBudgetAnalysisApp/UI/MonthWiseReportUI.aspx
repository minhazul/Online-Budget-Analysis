...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div class="row" style="padding-top: 50px;padding-bottom: 20px">
            ...
            <div class="col-sm-6">
                <h3>Gross monthly depiction report is generated by <b>Product Information & Daily Inventory Data</b> of particular <b>month of a year</b>.</h3>
            </div>
            <div class="col-sm-3"></div>
        </div>
    ...
    <div class="row">
            <div class="col-sm-4"></div>
                <div class="col-sm-4" style="text-align: center">
                    <h2><u>Gross Monthly Depiction Policy</u></h2>
                </div>
            <div class="col-sm-4"></div>
        </div>
        ...
        <div class="row" style="text-align: center; padding-top: 20px;padding-bottom: 0px">
            <asp:Button ID="btnGenerate" CssClass="btn btn-success" runat="server" Text="Generate" OnClick="btnGenerate_Click" />
        </div>
        
        <div class="row" style="text-align: center; padding-bottom: 40px;padding-top: 30px" runat="server" ID="paddingControl">
                <div class="col-sm-4"></div>
                <div class="col-sm-4" style="text-align: center">
